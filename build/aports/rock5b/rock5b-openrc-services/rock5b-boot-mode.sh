...
usage() {
  cat <<'USAGE'
Usage:
  rock5b-boot-mode status
  rock5b-boot-mode next-maintenance
  rock5b-boot-mode cancel-next
  rock5b-boot-mode set-default immutable|maintenance
  rock5b-boot-mode reboot-maintenance
  rock5b-boot-mode reboot-immutable
USAGE
}
