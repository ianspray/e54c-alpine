...
usage() {
  cat <<'USAGE'
Usage:
  e25-boot-mode status
  e25-boot-mode next-maintenance
  e25-boot-mode cancel-next
  e25-boot-mode set-default immutable|maintenance
  e25-boot-mode reboot-maintenance
  e25-boot-mode reboot-immutable
USAGE
}
