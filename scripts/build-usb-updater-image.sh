...
UPDATER_OVERHEAD_MIB="${UPDATER_OVERHEAD_MIB:-400}"
USB_IMAGE_SIZE="${USB_IMAGE_SIZE:-}"
USB_IMAGE_MIN_SIZE_MIB="${USB_IMAGE_MIN_SIZE_MIB:-1300}"
...
UPDATER_BOOT_DEVICE="${UPDATER_BOOT_DEVICE:-${BOARD_UPDATER_BOOT_DEVICE_DEFAULT:-}}"
...
UPDATER_ALPINE_PACKAGES="${UPDATER_ALPINE_PACKAGES:-alpine-base alpine-conf openssh mtd-utils dosfstools e2fsprogs zstd ${BOARD}-usb-updater-services}"
