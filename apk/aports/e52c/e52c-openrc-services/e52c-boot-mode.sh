...
usage() {
  cat <<'USAGE'
Usage:
  e52c-boot-mode status
  e52c-boot-mode next-maintenance
  e52c-boot-mode cancel-next
  e52c-boot-mode set-default immutable|maintenance
  e52c-boot-mode reboot-maintenance
  e52c-boot-mode reboot-immutable
USAGE
}
