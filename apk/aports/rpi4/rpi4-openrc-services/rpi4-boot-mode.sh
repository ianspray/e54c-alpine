...
usage() {
  cat <<'USAGE'
Usage:
  rpi4-boot-mode status
  rpi4-boot-mode next-maintenance
  rpi4-boot-mode cancel-next
  rpi4-boot-mode set-default immutable|maintenance
  rpi4-boot-mode reboot-maintenance
  rpi4-boot-mode reboot-immutable
USAGE
}
